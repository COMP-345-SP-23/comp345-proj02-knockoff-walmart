...
class ProductEmployeeTest {
    ...
    public void testGetInventoryInfoWithMultipleProducts(){
        ...
        String expected1 = "Product: Banana - Location: 1b - Stock: 10 - Price: $1.69 - Expiration date: 2023-01-01 - ID: 1001";
        String actual1 = e.getProductInfo(1001);
        assertEquals(expected1, actual1);

        String expected2 = "Product: Orange - Location: 2a - Stock: 10 - Price: $2.50 - Expiration date: 2023-02-02 - ID: 1002";
        String actual2 = e.getProductInfo(1002);
        assertEquals(expected2, actual2);

        String expected3 = "Product: Cucumber - Location: 3a - Stock: 10 - Price: $2.12 - Expiration date: 2023-03-03 - ID: 1003";
        String actual3 = e.getProductInfo(1003);
        assertEquals(expected3, actual3);

        String expected4 = "Product: Apple - Location: 4b - Stock: 10 - Price: $4.01 - Expiration date: 2023-04-04 - ID: 1004";
        String actual4 = e.getProductInfo(1004);
        assertEquals(expected4, actual4);

        String expected5 = "This product does not exist in this store.";
        String actual5 = e.getProductInfo(1005);
